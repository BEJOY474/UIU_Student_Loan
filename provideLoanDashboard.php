...
<?php 
                ...
                while ( $data = $result->fetch_assoc()) {
                    ...
                    $sql2 = "INSERT INTO dashboard (take_loan_user_id,pro_loan_user_id,pro_first_name,pro_last_name,pro_gender,
                    take_pro_first_name,take_pro_last_name,take_gender)
                    VALUES('$take_student_id' ,'$student_id' ,'$pro_first_name','$pro_last_name','$pro_gender',
                    '$take_pro_first_name' ,'$take_pro_last_name' ,'$take_gender'  )";

                    $result = $conn->query($sql2);
                
                    $sql3 = "INSERT INTO conversion (take_loan_user_id,pro_loan_user_id)
                    VALUES('$take_student_id' ,'$student_id'  )";
        ...
        <div class="mid">
            ...
            <?php 
                    ...
                    if ($_GET['take_student_id']) {
                        ...
                        $sqll = "DELETE FROM provide_loan_post WHERE student_id = $take_student_id";
