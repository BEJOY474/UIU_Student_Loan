    ...
    <div class="container1">
        ...
        <div class="mid">
            ...
            <?php
                    ...
                    $sqlk = "SELECT * FROM registration WHERE student_id = '$student_id' ";
            ...
            ?>
                            ...
                            <div class="card">
                                ...
                                <form class="form-card" action="provideBalance.php" method="POST">
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex"> <label
                                                class="form-control-label px-3">Your balance<span class="text-danger">
                                                </span></label>
                                        ...
                                        <div class="form-group col-sm-6 flex-column d-flex"> <label
                                              ...
                                              <input type="text" name="amount" readonly  value="<?php echo "$pro_first_name $pro_last_name" ?>" placeholder="Enter your amount">
                                        </div>

                                        <div class="form-group col-sm-6 flex-column d-flex"> <label
                                                class="form-control-label px-3">Id number<span class="text-danger">
                                                </span></label>
                                              <input type="text" name="amount" readonly  value="<?php echo "$student_id" ?>" placeholder="Enter your amount">
                                        </div>
