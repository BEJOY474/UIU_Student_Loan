...
<body>
    ...
    <div class="container1">
        ...
        <div class="left-sidebar">
            <div class="imp-links">
                <a href="myProfile2.php"><img src="socialmage/man.png"
        ...
        <?php 
           ...
           if ($take_gender == 'male') {
                ...
                <div class='mid'>
                <div class='container'>
                    <h3 class='details_Profile'>Details profile</h3>
                    <div class='main-body'>
                        <div class='row'>
                            <div class='col-lg-4'>
                                <div class='card'>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        ...
                                        <img src="socialmage/boy.png"
                                            class="rounded-circle p-1 bg-primary" width="110">
                                        <div class="mt-3">
                                            <h4><?php echo "$take_pro_first_name". " ". $take_pro_last_name ?></h4>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <h6 class="mb-0"> <img src="socialmage/facebook.png" alt=""> Facebook</h6>
                                            <span class="text-secondary"><?php echo "$take_facebook" ?></span>
                                        </li>
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <h6 class="mb-0"><img src="socialmage/link.png" alt="">Linkedin</h6>
                                            <span class="text-secondary"><?php echo "$take_linkdin" ?></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body rightSide">
                                    <div class="row mb-3 allInput">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control "
                                                value="<?php echo "$take_pro_first_name" . " ".$take_pro_last_name ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 allInput">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control"
                                                value="<?php echo "$take_student_id" ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 allInput">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control"
                                                value="<?php echo "$take_pro_email" ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 allInput">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control"
                                                value="<?php echo "$take_pro_phon" ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 allInput">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control"
                                                value="<?php echo "$take_pro_department" ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 allInput">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control"
                                                value="<?php echo "$take_pro_loan"." loan" ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 allInput">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control" value="<?php echo "$take_gender" ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 allInput">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control"
                                                value="<?php echo "$take_trimester" ?>" readonly>
                                        </div>
                                    </div>
