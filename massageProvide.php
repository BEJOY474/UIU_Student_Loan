            ...
            <div class="navbar-collapse collapse" id="navigation">
                <div class="padding-nav">
                    <ul class="nav navbar-nav left ul">
                        ...
                        <li class="active">
                            <a href="provideLone.php"><?php echo "$loan"." " ."LOAN" ?></a>
                        </li>
                        <li>
...
if ($_GET['take_pro_first_name']) {
    $take_first_name = $_GET['take_pro_first_name'];

}

if ($_GET['take_pro_last_name']) {
    $take_last_name = $_GET['take_pro_last_name'];
...
?>
                            ...
                            <div class="chat">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="chat-about">
                                                <h6 class="m-b-0"><?php echo "$take_first_name $take_last_name"; ?></h6>
                                                <small></small>
                                            </div>
                                        </div>
                             ...
                             <?php 
                                ...
                                if ($_GET['take_loan_user_id']) {
                                    $take_loan_user_id = $_GET['take_loan_user_id'];
                                ...
                                $sql = "INSERT INTO conversion (take_loan_user_id,pro_loan_user_msg, pro_loan_user_id)
                                VALUES('$take_loan_user_id' , '$msg' , '$student_id')";
                            ...
                            ?>
                                ...
                                <?php 
                                    ...
                                    if ($_GET['take_loan_user_id']) {
                                        $take_loan_id = $_GET['take_loan_user_id'];
    
                                    }

 

                                    $sql = "SELECT * FROM conversion WHERE pro_loan_user_id = $student_id and take_loan_user_id = $take_loan_id ";
                                    $result = $conn->query($sql);
                                        ...
                                        <div class='chat-history'>
                                          <ul class='m-b-0'>
                                            <li class='clearfix'>
                                                ...
                                                <div class='message other-message float-righ'>$pro_loan_user_msg </div>
                                            </li>
                                            ...
                                            <li class='clearfix'>
                                                ...
                                                <div class='message my-message'>$take_loan_user_msg</div>
                                            </li>
