                        ...
                        <div class="card">
                            <div class="image-content">
                                ...
                                <div class="card-image">
                                    <img src="images/download.jpg" alt class="card-img">
                                </div>
                            </div>
                            <div class="card-content">
                                <h3 class="heading">Donate money for flood affected people</h3>
                                <p>Help a sick friend or family member who has lost
                                    a loved one or is <br>unwell due to illness or
                                    accident. Raise money for medical treatment,
                                    surgery,<br> living and relocation expenses,
                                    life-saving drugs, time off work, overseas or
                                    alternative<br> treatment, carer costs.</p>
                                <a href="donateMoney.php"><button class="btnD">Donate</button></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-wrapper">
                        <div class="card">
                            <div class="image-content">
                                ...
                                <div class="card-image">
                                    <img src="images/dn6.jpeg" alt class="card-img">
                                </div>
                            </div>
                            <div class="card-content">
                                <h3 class="heading">Help poor people</h3>
                                <p>Help a sick friend or family member who has lost
                                    a loved one or is <br>unwell due to illness or
                                    accident. Raise money for medical treatment,
                                    surgery,<br> living and relocation expenses,
                    ...
                    <div class="card-wrapper">
                        <div class="card">
                            <div class="image-content">
                                ...
                                <div class="card-image">
                                    <img src="images/dn8 (3).jpeg" alt class="card-img">
                                </div>
                            </div>
                            <div class="card-content">
                                <h3>Donate money for street children </h3>
                                <p> We all want the children in our lives to
                                    grow into compassionate people<br> and, by
                                    showing them the positive impact you can
                                    have by simply<br> donating money to
                                    charity, you can show them how easy it is to
                                    help out <br>vulnerable children and their
                                    communities</p>
                                <a href="donateMoney.php"><button class="btnD">Donate</button></a>
                            </div>
                        </div>
