...
<body>
    ...
    <div class="container1">
        ...
        <?php
                ...
                if ($_GET['take_st_Id']) {
                    $take_student_id = $_GET['take_st_Id'];
                    ...
                    if ($query->num_rows> 0) {
                        ...
                        $take_father_name = $data['father_name'];
                        $take_mother_name = $data['mother_name'];
                        $take_phon = $data['phon'];
                ...
                $sql2 = "SELECT * FROM allpost WHERE student_id = '$student_id' ";
    ...
    ?>
        ...
        <div class="mid">
            <div class="main-content " id="box" >
                <p class="headLine">Loan Receipt</p>
                <div class="tableStrt">
                    <table>
                        <tr>
                            <th>Provide loan</th>
                        ...
                        <tr>
                            <td>Student Id : <?php echo "$student_id" ?></td>
                            <td>Student Id : <?php echo "$take_student_id" ?></td>
                           
                        </tr>

                        <tr>
                            <td>Name : <?php echo "$pro_first_name $pro_last_name" ?></td>
                            <td>Name : <?php echo "$take_first_name $take_last_name" ?></td>
                          
                        </tr>
                        <tr>
                                <td>Amount : <?php echo "$pro_amount_a" ?></td>
                                <td>Amount : <?php echo "$pro_amount_a" ?></td>
                            
                        </tr>
                        <tr>
                            <td>Interest : <?php echo "$interest%" ?></td>
                            <td>Trimester : <?php echo "$take_trimester" ?></td>
                           
                        </tr>
                      
                        <tr>
                            <td>Installment : <?php echo "$pro_installment" ?></td>
                            <td>Installment : <?php echo "$pro_installment" ?></td>
                           
                        </tr>
                        <tr>
                            <td>Duration : <?php echo "$pro_duration" ?></td>
                            <td>Duration : <?php echo "$pro_duration" ?></td>
                          
                        </tr>  

                          <tr>
                            <td>Phone : <?php echo "$pro_phon" ?></td>
                            <td>Phone : <?php echo "$take_phon" ?></td>
                          
                        </tr>  

                           <tr>
                            <td>Depertment : <?php echo "$pro_department" ?></td>
                            <td>Depertment : <?php echo "$take_department" ?></td>
            ...
            <div class="button text-center">
                <center><button  type="submit" onclick="printPage('box')"  name="submit">Download Loan Receipt</button></center>
            </div>
        </div>
