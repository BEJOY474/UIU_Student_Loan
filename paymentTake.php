    ...
    <div class="container1">
        ...
        <div class="mid">
            ...
            <?php 
                    ...
                    if (isset($_GET['bkash'])) {
                        if ($_GET['provide_student_id']) {
                            $provide_student_id = $_GET['provide_student_id'];
    
                            $sql = "SELECT* FROM registration WHERE student_id = '$provide_student_id'  " ;        
                                            ...
                                            <div class='row d-flex justify-content-center'>
                                                <div class='col-xl-7 col-lg-8 col-md-9 col-11 text-center'>
                                                    ...
                                                    <div class='card'>
                                                        ...
                                                        <form class='form-car' action='paymentTake.php' method='POST'>
                                                            <div class='row justify-content-between text-left'>
                                                                ...
                                                                <div class='form-group col-sm-6 flex-column d-flex'> <label
                                                                        class='form-control-label px-3'>Student ID who issued you the loan<span
                                                                            class='text-danger'>
                                                                            *</span></label>
                                                                    <input type='text' name='take_st_id' value='$provide_student_id' placeholder''>
                                                                </div>
                                                            </div>
                                                            <div class='row justify-content-between text-left'>
                                                                <div class='form-group col-sm-6 flex-column d-flex'> <label
        ...
        <?php 
                    ...
                    $totalBalance = $balance - $pro_amount;
                   ...
                   // echo "$totalBalance2";
                        ...
                        SET balance='$totalBalance',due_balance='$totalBalance', due_instlmnt='$installment'
                        WHERE take_user_id='$student_id' ";
                        $result = $conn->query($sql1);

                        $sql5 =   "UPDATE takeloanbalance 
                        SET balance='$totalBalance2',due_balance='$totalBalance2', due_instlmnt='$installment_2'
                        WHERE take_user_id='$take_st_id' ";
                        $result = $conn->query($sql5);
                            ...
                            if(mysqli_query($conn, $sql1)==TRUE){
                              ...
                              if (mysqli_query($conn, $sql5)==TRUE) {
                                echo "<script>window.location.href='reciptTake.php?take_st_Id=$take_st_id&pro_amount=$pro_amount';</script>";
