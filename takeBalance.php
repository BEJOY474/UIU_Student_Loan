                                ...
                                <form class="form-card" action="applyLoan.php" method="POST">
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex"> <label
                                              ...
                                              <input type="text" name="amount" readonly  value="<?php echo "$balance" ?>" placeholder="Enter your amount">
                                        </div>
                                        <div class="form-group col-sm-6 flex-column d-flex"> <label
                                                class="form-control-label px-3">Due to pay loan <span class="text-danger">
                                                    </span></label>
                                            <input type="text" name="duration" readonly value="<?php echo "$due_balance" ?>" placeholder="5 month*">
                                        </div>
                                    </div>
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex"> <label
                                                class="form-control-label px-3">Installment<span
                                                    class="text-danger"> </span></label>
                                            <input type="text" name="msg" readonly value="<?php echo "$installment" ?>" placeholder="I will take a loan for...">
                                        </div>

                                        <!-- <div class="form-group col-sm-6 flex-column d-flex"> <label
                                                class="form-control-label px-3">Current trimester<span class="text-danger">
                                                    *</span></label>
                                            <input type="text" id="mob" name="trimester" placeholder="Current trimester">
                                        </div> -->
                                    </div>
