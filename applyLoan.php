                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                            ...
                            <div class="card">
                                ...
                                <form class="form-card" action="applyLoan.php" method="POST">
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex"> <label
                                                class="form-control-label px-3">Amount<span class="text-danger">
                                                    *</span></label>
                                              <input type="text" name="amount" required placeholder="Enter your amount">
                                        </div>
                                        <div class="form-group col-sm-6 flex-column d-flex"> <label
                                                class="form-control-label px-3">Duration <span class="text-danger">
                                                    *</span></label>
                                            <input type="text" name="duration" required placeholder="5 month*">
                                        </div>
                                    </div>
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex"> <label
                                                class="form-control-label px-3">What is the reason for taking a loan?<span
                                                    class="text-danger"> *</span></label>
                                            <input type="text" name="msg" required placeholder="I will take a loan for...">
                                        </div>

                                        <div class="form-group col-sm-6 flex-column d-flex"> <label
                                                class="form-control-label px-3">Current trimester<span class="text-danger">
                                                    *</span></label>
                                            <input type="text" id="mob" required name="trimester" placeholder="Current trimester">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="form-group col-sm-6"> <button type="submit" name="post"
                                                class="btn-block btn-primary text-center">Apply</button> </div>
                                    </div>
                                </form>
                                ...
                                <?php 
                                                    ...
                                                    if ( isset($_POST['post'])) {
                                                        ...
                                                        $sql_2 = "INSERT INTO provide_loan_post (student_id,pro_amount,pro_duration,
                                                        first_name,last_name,	email,father_name,mother_name,phon,department,loan, gender,msg)
                                                        VALUES('$student_id','$amount'   ,'$duration',
                                                        '$first_name' , '$last_name' ,'$email','$father_name' , '$mother_name' , '$phon','$department','$loan', '$gender','$msg')";
                                                   
                                                   
                                                   $sql_3 = "INSERT INTO allpost (student_id,pro_amount,pro_duration,
                                                   first_name,last_name,	email,father_name,mother_name,phon,department,loan, gender,msg)
                                                   VALUES('$student_id','$amount'   ,'$duration',
                                                   '$first_name' , '$last_name' ,'$email','$father_name' , '$mother_name' , '$phon','$department','$loan', '$gender','$msg')";
                                                   ...
                                                   if ($conn->query($sql_2)== TRUE) {
                                                       if ($conn->query($sql_3)== TRUE) {
                                                         echo "<script>window.location.href='takeLoan.php';</script>";
                                                       }
